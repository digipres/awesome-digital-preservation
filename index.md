...
* Engage Stakeholders:
    ...
    * Working with your IT department (some responses arising from [this question on twitter](https://twitter.com/anjacks0n/status/809343452995522560):
      ...
      * [Ten IT skills you need to have to work with digital preservation](https://dl.dropboxusercontent.com/u/95767577/Ten%20IT%20skills%20you%20need%20to%20have.pdf), by [Dave Thompson](https://twitter.com/d_n_t)
...
* Test tools using publicly-available test corpora (see below)
...
* Understand [file format risks](http://wiki.opf-labs.org/display/TR/OPF+File+Format+Risk+Registry) ([e.g. JP2](http://wiki.opf-labs.org/display/TR/JP2))
    * If you have good examples of digital resources and their risks, please consider adding them to <a href="#test-corpora">a test corpus</a>.
